CREATE TABLE IF NOT EXISTS banner_info (
    ...
    begin_time VARCHAR(19) NOT NULL COMMENT '开始时间，格式：yyyy-MM-dd HH:mm:ss',
    end_time VARCHAR(19) NOT NULL COMMENT '结束时间，格式：yyyy-MM-dd HH:mm:ss',
    url VARCHAR(1000) NOT NULL COMMENT 'Banner资源地址',
    status TINYINT NOT NULL DEFAULT 1 COMMENT '状态：0-停用，1-启用',
    create_time VARCHAR(19) NOT NULL COMMENT '创建时间，格式：yyyy-MM-dd HH:mm:ss',
